        ...
        <div :class="($screenSize < 980) ? 'col-sm-12' : 'col-sm-6'">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <form @submit.stop.prevent="bankingRequest">
                    ...
                    <div class="form-group div_txt">
                      <label style="font-size: 18px;font-weight: 600;" for="amount">Amount</label>
                      <b-form-input
                          id="amount"
                          v-model="fm.amount"
                          type="amount"
                    ...
                    <div class="form-group div_txt">
                      <label style="font-size: 18px;font-weight: 600;" for="operator">Payment Operator</label>
                      <v-select
                          id="operator"
                          v-model="fm.operator"
                          name="operator"
