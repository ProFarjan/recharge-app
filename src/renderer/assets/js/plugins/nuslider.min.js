...
!(function (a) {
  ...
  function a (a) {
    return typeof a === 'object' && typeof a.to === 'function' && typeof a.from === 'function'
  }
  ...
  function A (a, b, c) {
    ...
    if (d = a === 'min' ? 0 : a === 'max' ? 100 : parseFloat(a), !g(d) || !g(b[0])) throw new Error('noUiSlider (' + $ + "): 'range' value isn't numeric.")
  ...
  function C (a, b, c) {
    ...
    for (e.sort(e.length && typeof e[0][0] === 'object' ? function (a, b) {
      return a[0][0] - b[0][0]
    } : function (a, b) {
      return a[0] - b[0]
  ...
  function Y (a, e, g) {
    ...
    function s (a, b) {
      ...
      return d.setAttribute('data-handle', b), d.setAttribute('tabindex', '0'), d.setAttribute('role', 'slider'), d.setAttribute('aria-orientation', e.ort ? 'vertical' : 'horizontal'), b === 0 ? l(d, e.cssClasses.handleLower) : b === e.handles - 1 && l(d, e.cssClasses.handleUpper), c
    }
    ...
    function v (a) {
      l(a, e.cssClasses.target), e.dir === 0 ? l(a, e.cssClasses.ltr) : l(a, e.cssClasses.rtl), e.ort === 0 ? l(a, e.cssClasses.horizontal) : l(a, e.cssClasses.vertical), ha = k(a, e.cssClasses.base)
    }
    ...
    function z (a, b, c) {
      ...
      return a === 'positions' ? b.map(function (a) {
        return ta.fromStepping(c ? ta.getStep(a) : a)
      }) : a === 'values' ? c ? b.map(function (a) {
    ...
    function A (a, b, c) {
      ...
      return c = d(c.slice().sort(function (a, b) {
        ...
        var h, l, m, n, o, p, q, r, s, t, u = d,
          v = c[g + 1]
        if (b === 'steps' && (h = ta.xNumSteps[g]), h || (h = v - u), u !== !1 && void 0 !== v) {
          for (h = Math.max(h, 1e-7), l = u; v >= l; l = e(l, h)) {
            ...
            q = c.indexOf(l) > -1 ? 1 : b === 'steps' ? 2 : 0, !g && i && (q = 0), l === v && j || (f[n.toFixed(5)] = [l, q]), k = n
          }
        }
      }), f
    }
    ...
    function B (a, b, c) {
      ...
      return l(g, e.cssClasses.pips), l(g, e.ort === 0 ? e.cssClasses.pipsHorizontal : e.cssClasses.pipsVertical), Object.keys(a).forEach(function (b) {
        f(b, a[b])
      }), g
    }
    ...
    function L (a, b) {
      a.type === 'mouseout' && a.target.nodeName === 'HTML' && a.relatedTarget === null && N(a, b)
    }

    function M (a, b) {
      if (navigator.appVersion.indexOf('MSIE 9') === -1 && a.buttons === 0 && b.buttonsProperty !== 0) return N(a, b)
    ...
    function Q (a) {
      ...
      Object.keys(va).forEach(function (a) {
        a.split('.')[0] === 'hover' && va[a].forEach(function (a) {
          a.call(ka, d)
        })
      })
    }
    ...
    function S (a, b, c, d, f, g) {
      return ia.length > 1 && (d && b > 0 && (c = Math.max(c, a[b - 1] + e.margin)), f && b < ia.length - 1 && (c = Math.min(c, a[b + 1] - e.margin))), ia.length > 1 && e.limit && (d && b > 0 && (c = Math.min(c, a[b - 1] + e.limit)), f && b < ia.length - 1 && (c = Math.max(c, a[b + 1] - e.limit))), e.padding && (b === 0 && (c = Math.max(c, e.padding)), b === ia.length - 1 && (c = Math.min(c, 100 - e.padding))), c = ta.getStep(c), c = i(c), c !== a[b] || g ? c : !1
    }
    ...
    function Y (a) {
      if (ja[a]) {
        var b = 0,
          c = 100
        a !== 0 && (b = qa[a - 1]), a !== ja.length - 1 && (c = qa[a]), ja[a].style[e.style] = T(b), ja[a].style[e.styleOposite] = T(100 - c)
      }
    }

    function Z (a, b) {
      a !== null && a !== !1 && (typeof a === 'number' && (a = String(a)), a = e.format.from(a), a === !1 || isNaN(a) || W(b, ta.toStepping(a), !1, !1))
    }
    ...
    function ea (a, b) {
      va[a] = va[a] || [], va[a].push(b), a.split('.')[0] === 'update' && ia.forEach(function (a, b) {
        K('update', b)
      })
    }
