...
function __guard__ (a, b) {
  return void 0 !== a && a !== null ? b(a) : void 0
}

function __guardMethod__ (a, b, c) {
  return void 0 !== a && a !== null && typeof a[b] === 'function' ? c(a, b) : void 0
}
  ...
  Dropzone = (function (a) {
    function b (a, c) {
      ...
      var d = _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this)),
        e = void 0,
        f = void 0
      if (d.element = a, d.version = b.version, d.defaultOptions.previewTemplate = d.defaultOptions.previewTemplate.replace(/\n*/g, ''), d.clickableElements = [], d.listeners = [], d.files = [], typeof d.element === 'string' && (d.element = document.querySelector(d.element)), !d.element || d.element.nodeType == null) throw new Error('Invalid dropzone element.')
      if (d.element.dropzone) throw new Error('Dropzone already attached.')
      b.instances.push(d), d.element.dropzone = d
      var g = (f = b.optionsForElement(d.element)) != null ? f : {}
      if (d.options = b.extend({}, d.defaultOptions, g, c != null ? c : {}), d.options.forceFallback || !b.isBrowserSupported()) {
        var h
        return h = d.options.fallback.call(d), _possibleConstructorReturn(d, h)
      }
      if (d.options.url == null && (d.options.url = d.element.getAttribute('action')), !d.options.url) throw new Error('No URL provided.')
      ...
      return d.options.acceptedMimeTypes && (d.options.acceptedFiles = d.options.acceptedMimeTypes, delete d.options.acceptedMimeTypes), d.options.renameFilename != null && (d.options.renameFile = function (a) {
    ...
    return _inherits(b, a), _createClass(b, null, [{
      ...
      value: function () {
        this.prototype.Emitter = Emitter, this.prototype.events = ['drop', 'dragstart', 'dragend', 'dragenter', 'dragover', 'dragleave', 'addedfile', 'addedfiles', 'removedfile', 'thumbnail', 'error', 'errormultiple', 'processing', 'processingmultiple', 'uploadprogress', 'totaluploadprogress', 'sending', 'sendingmultiple', 'success', 'successmultiple', 'canceled', 'canceledmultiple', 'complete', 'completemultiple', 'reset', 'maxfilesexceeded', 'maxfilesreached', 'queuecomplete'], this.prototype.defaultOptions = {
          ...
          fallback: function () {
            ...
            return g && (g.textContent != null ? g.textContent = this.options.dictFallbackMessage : g.innerText != null && (g.innerText = this.options.dictFallbackMessage)), this.element.appendChild(this.getFallbackForm())
          },
          resize: function (a, b, c, d) {
            var e = {
              ...
              f = a.width / a.height
            b == null && c == null ? (b = e.srcWidth, c = e.srcHeight) : b == null ? b = c * f : c == null && (c = b / f), b = Math.min(b, e.srcWidth), c = Math.min(c, e.srcHeight)
            var g = b / c
            if (e.srcWidth > b || e.srcHeight > c) {
              if (d === 'crop') f > g ? (e.srcHeight = a.height, e.srcWidth = e.srcHeight * g) : (e.srcWidth = a.width, e.srcHeight = e.srcWidth / g)
              else {
                if (d !== 'contain') throw new Error("Unknown resizeMethod '" + d + "'")
                f > g ? c = b / f : b = c * f
              }
            }
          ...
          removedfile: function (a) {
            return a.previewElement != null && a.previewElement.parentNode != null && a.previewElement.parentNode.removeChild(a.previewElement), this._updateMaxFilesReachedClass()
          },
          ...
          error: function (a, b) {
            if (a.previewElement) {
              a.previewElement.classList.add('dz-error'), typeof b !== 'String' && b.error && (b = b.error)
          ...
          uploadprogress: function (a, b, c) {
            if (a.previewElement) {
              for (var d = a.previewElement.querySelectorAll('[data-dz-uploadprogress]'), e = 0, d = d; ;) {
                ...
                f = d[e++]
                var g = f
                g.nodeName === 'PROGRESS' ? g.value = b : g.style.width = b + '%'
              }
            }
          },
      ...
      value: function () {
        ...
        if (this.element.tagName === 'form' && this.element.setAttribute('enctype', 'multipart/form-data'), this.element.classList.contains('dropzone') && !this.element.querySelector('.dz-message') && this.element.appendChild(b.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + '</span></div>')), this.clickableElements.length) {
          !(function b () {
            return a.hiddenFileInput && a.hiddenFileInput.parentNode.removeChild(a.hiddenFileInput), a.hiddenFileInput = document.createElement('input'), a.hiddenFileInput.setAttribute('type', 'file'), (a.options.maxFiles === null || a.options.maxFiles > 1) && a.hiddenFileInput.setAttribute('multiple', 'multiple'), a.hiddenFileInput.className = 'dz-hidden-input', a.options.acceptedFiles !== null && a.hiddenFileInput.setAttribute('accept', a.options.acceptedFiles), a.options.capture !== null && a.hiddenFileInput.setAttribute('capture', a.options.capture), a.hiddenFileInput.style.visibility = 'hidden', a.hiddenFileInput.style.position = 'absolute', a.hiddenFileInput.style.top = '0', a.hiddenFileInput.style.left = '0', a.hiddenFileInput.style.height = '0', a.hiddenFileInput.style.width = '0', document.querySelector(a.options.hiddenInputContainer).appendChild(a.hiddenFileInput), a.hiddenFileInput.addEventListener('change', function () {
        ...
        this.on('uploadprogress', function () {
          ...
          if (a.getAddedFiles().length === 0 && a.getUploadingFiles().length === 0 && a.getQueuedFiles().length === 0) {
            return setTimeout(function () {
        ...
        return this.listeners = [{
          ...
          events: {
            ...
            dragover: function (b) {
              ...
              return b.dataTransfer.dropEffect = c === 'move' || c === 'linkMove' ? 'move' : 'copy', g(b), a.emit('dragover', b)
            },
      ...
      key: 'destroy',
      value: function () {
        return this.disable(), this.removeAllFiles(!0), (this.hiddenFileInput != null ? this.hiddenFileInput.parentNode : void 0) && (this.hiddenFileInput.parentNode.removeChild(this.hiddenFileInput), this.hiddenFileInput = null), delete this.element.dropzone, b.instances.splice(b.instances.indexOf(this), 1)
      }
    }, {
      ...
      key: '_getParamName',
      value: function (a) {
        return typeof this.options.paramName === 'function' ? this.options.paramName(a) : this.options.paramName + (this.options.uploadMultiple ? '[' + a + ']' : '')
      }
    }, {
      key: '_renameFile',
      value: function (a) {
        return typeof this.options.renameFile !== 'function' ? a.name : this.options.renameFile(a)
      }
    }, {
      key: 'getFallbackForm',
      value: function () {
        ...
        return this.element.tagName !== 'FORM' ? (c = b.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>'), c.appendChild(e)) : (this.element.setAttribute('enctype', 'multipart/form-data'), this.element.setAttribute('method', this.options.method)), c != null ? c : e
      }
    }, {
      ...
      value: function (a) {
        if (a.dataTransfer) {
          ...
          if (this.emit('addedfiles', b), b.length) {
            ...
            c && c.length && c[0].webkitGetAsEntry != null ? this._addFilesFromItems(c) : this.handleFiles(b)
          }
        }
      }
    }, {
      key: 'paste',
      value: function (a) {
        if (__guard__(a != null ? a.clipboardData : void 0, function (a) {
          return a.items
        }) != null) {
          this.emit('paste', a)
      ...
      value: function (a) {
        ...
        return (function () {
          for (var c = [], d = a, e = 0, d = d; ;) {
            ...
            f = d[e++]
            var g, h = f
            h.webkitGetAsEntry != null && (g = h.webkitGetAsEntry()) ? g.isFile ? c.push(b.addFile(h.getAsFile())) : g.isDirectory ? c.push(b._addFilesFromDirectory(g, g.name)) : c.push(void 0) : h.getAsFile != null && (h.kind == null || h.kind === 'file') ? c.push(b.addFile(h.getAsFile())) : c.push(void 0)
          }
          return c
        }())
      }
      ...
      key: 'accept',
      value: function (a, c) {
        return a.size > 1024 * this.options.maxFilesize * 1024 ? c(this.options.dictFileTooBig.replace('{{filesize}}', Math.round(a.size / 1024 / 10.24) / 100).replace('{{maxFilesize}}', this.options.maxFilesize)) : b.isValidFile(a, this.options.acceptedFiles) ? this.options.maxFiles != null && this.getAcceptedFiles().length >= this.options.maxFiles ? (c(this.options.dictMaxFilesExceeded.replace('{{maxFiles}}', this.options.maxFiles)), this.emit('maxfilesexceeded', a)) : this.options.accept.call(this, a, c) : c(this.options.dictInvalidFileType)
      }
    }, {
      key: 'addFile',
      value: function (a) {
      ...
      value: function (a) {
        ...
        if (this.options.createImageThumbnails && a.type.match(/image.*/) && a.size <= 1024 * this.options.maxThumbnailFilesize * 1024) {
          return this._thumbnailQueue.push(a), setTimeout(function () {
      ...
      key: 'removeFile',
      value: function (a) {
        if (a.status === b.UPLOADING && this.cancelUpload(a), this.files = without(this.files, a), this.emit('removedfile', a), this.files.length === 0) return this.emit('reset')
      }
    }, {
      key: 'removeAllFiles',
      value: function (a) {
      ...
      value: function (a, c, d, e, f) {
        ...
        return this.createThumbnail(a, c, d, e, !1, function (c, d) {
          if (d === null) return f(a)
          var e = g.options.resizeMimeType
          e == null && (e = a.type)
          var h = d.toDataURL(e, g.options.resizeQuality)
          return e !== 'image/jpeg' && e !== 'image/jpg' || (h = ExifRestore.restore(a.dataURL, h)), f(b.dataURItoBlob(h))
        })
      }
    }, {
      key: 'createThumbnail',
      value: function (a, b, c, d, e, f) {
        ...
        return h.onload = function () {
          return a.dataURL = h.result, a.type === 'image/svg+xml' ? void (f != null && f(h.result)) : g.createThumbnailFromUrl(a, b, c, d, e, f)
        }, h.readAsDataURL(a)
      }
    }, {
      ...
      value: function (a, b, c, d, e, f, g) {
        ...
        return g && (i.crossOrigin = g), i.onload = function () {
          ...
          return typeof EXIF !== 'undefined' && EXIF !== null && e && (g = function (a) {
            ...
            drawImageIOSFix(k, i, g.srcX != null ? g.srcX : 0, g.srcY != null ? g.srcY : 0, g.srcWidth, g.srcHeight, g.trgX != null ? g.trgX : 0, g.trgY != null ? g.trgY : 0, g.trgWidth, g.trgHeight)
            var l = j.toDataURL('image/png')
            if (f != null) return f(l, j)
          })
        }, f != null && (i.onerror = f), i.src = a.dataURL
      }
    }, {
      key: 'processQueue',
      value: function () {
      ...
      value: function (a, c) {
        ...
        }, (e.upload != null ? e.upload : e).onprogress = function (b) {
        ...
        if (this.options.params) {
          ...
          typeof o === 'function' && (o = o.call(this, a, e, a[0].upload.chunked ? this._getChunk(a[0], e) : null))
          for (var p in o) {
            var q = o[p]
            n.append(p, q)
          }
      ...
      value: function (a) {
        if (this.element.tagName === 'FORM') {
          for (var b = this.element.querySelectorAll('input, textarea, select, button'), c = 0, b = b; ;) {
            ...
            if (g && (g = g.toLowerCase()), void 0 !== f && f !== null) {
              ...
              } else (!g || g !== 'checkbox' && g !== 'radio' || e.checked) && a.append(f, e.value)
            }
          }
        }
      }
      ...
      value: function (a, b, c) {
        ...
        if (void 0 !== c) {
          ...
          for (var q = a, r = 0, q = q; ;) {
            ...
            s = q[r++]
            var t = s
            t.upload.progress === 100 && t.upload.bytesSent === t.upload.total || (p = !1), t.upload.progress = d, t.upload.bytesSent = t.upload.total
          }
          if (p) return
          for (var u = a, v = 0, u = u; ;) {
            var w
      ...
      value: function (a, c, d) {
        var e = void 0
        if (a[0].status !== b.CANCELED && c.readyState === 4) {
          if (c.responseType !== 'arraybuffer' && c.responseType !== 'blob' && (e = c.responseText, c.getResponseHeader('content-type') && ~c.getResponseHeader('content-type').indexOf('application/json'))) {
            try {
              e = JSON.parse(e)
            } catch (a) {
          ...
          this._updateFilesUploadProgress(a), c.status >= 200 && c.status < 300 ? a[0].upload.chunked ? a[0].upload.finishedChunkUpload(this._getChunk(a[0], c)) : this._finished(a, e, d) : this._handleUploadError(a, c, e)
        }
      }
    }, {
      ...
      value: function () {
        return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (a) {
          ...
          return (a === 'x' ? b : 3 & b | 8).toString(16)
        })
      }
    }]), b
  }(Emitter))
Dropzone.initClass(), Dropzone.version = '5.2.0', Dropzone.options = {}, Dropzone.optionsForElement = function (a) {
  ...
  if (typeof a === 'string' && (a = document.querySelector(a)), (a != null ? a.dropzone : void 0) == null) throw new Error("No Dropzone found for given element. This is probably because you're trying to access it before Dropzone had the time to initialize. Use the `init` option to setup any additional observers on your Dropzone.")
  return a.dropzone
  ...
  for (var b = atob(a.split(',')[1]), c = a.split(',')[0].split(':')[1].split(';')[0], d = new ArrayBuffer(b.length), e = new Uint8Array(d), f = 0, g = b.length, h = g >= 0; h ? f <= g : f >= g; h ? f++ : f--) e[f] = b.charCodeAt(f)
  return new Blob([d], {
    type: c
  })
}
...
Dropzone.createElement = function (a) {
  ...
  var c = void 0
  if (typeof a === 'string' ? c = document.querySelector(a) : a.nodeType != null && (c = a), c == null) throw new Error('Invalid `' + b + '` option provided. Please provide a CSS selector or a plain HTML element.')
  return c
  ...
  } else a.nodeType != null && (d = [a])
  if (d == null || !d.length) throw new Error('Invalid `' + b + '` option provided. Please provide a CSS selector, a plain HTML element or a list of those.')
  return d
}, Dropzone.confirm = function (a, b, c) {
  return window.confirm(a) ? b() : c != null ? c() : void 0
  ...
  for (var c = a.type, d = c.replace(/\/.*$/, ''), e = b, f = 0, e = e; ;) {
    ...
    if (h = h.trim(), h.charAt(0) === '.') {
      if (a.name.toLowerCase().indexOf(h.toLowerCase(), a.name.length - h.length) !== -1) return !0
    } else if (/\/\*$/.test(h)) {
      if (d === h.replace(/\/.*$/, '')) return !0
    } else if (c === h) return !0
  }
  return !1
}, typeof jQuery !== 'undefined' && jQuery !== null && (jQuery.fn.dropzone = function (a) {
  return this.each(function () {
    return new Dropzone(this, a)
  })
}), typeof module !== 'undefined' && module !== null ? module.exports = Dropzone : window.Dropzone = Dropzone, Dropzone.ADDED = 'added', Dropzone.QUEUED = 'queued', Dropzone.ACCEPTED = Dropzone.QUEUED, Dropzone.UPLOADING = 'uploading', Dropzone.PROCESSING = Dropzone.UPLOADING, Dropzone.CANCELED = 'canceled', Dropzone.ERROR = 'error', Dropzone.SUCCESS = 'success'
    ...
    return _createClass(a, null, [{
      ...
      value: function (a) {
        for (var b = void 0, c = 0; c < a.length;) {
          if (b = a[c], b[0] === 255 & b[1] === 225) return b
          c++
        }
        return []
      }
      ...
      value: function (a) {
        for (var b = 0, c = []; ;) {
          var d
          if (a[b] === 255 & a[b + 1] === 218) break
          if (a[b] === 255 & a[b + 1] === 216) b += 2
          else {
            d = 256 * a[b + 2] + a[b + 3]
            var e = b + d + 2,
              f = a.slice(b, e)
      ...
      value: function (a) {
        var b = void 0,
          ...
          j = [],
          k = /[^A-Za-z0-9\+\/\=]/g
        for (k.exec(a) && console.warn("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."), a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ''); ;) { if (e = this.KEY_STR.indexOf(a.charAt(i++)), f = this.KEY_STR.indexOf(a.charAt(i++)), g = this.KEY_STR.indexOf(a.charAt(i++)), h = this.KEY_STR.indexOf(a.charAt(i++)), b = e << 2 | f >> 4, c = (15 & f) << 4 | g >> 2, d = (3 & g) << 6 | h, j.push(b), g !== 64 && j.push(c), h !== 64 && j.push(d), b = c = d = '', e = f = g = h = '', !(i < a.length)) break }
        return j
      }
    }]), a
  }())
...
var contentLoaded = function (a, b) {
  var c = !1,
    ...
    j = function d (f) {
      if (f.type !== 'readystatechange' || e.readyState === 'complete') return (f.type === 'load' ? a : e)[h](i + f.type, d, !1), !c && (c = !0) ? b.call(a, f.type || f) : void 0
    }
