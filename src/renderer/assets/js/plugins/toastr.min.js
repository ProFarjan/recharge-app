!(function (e) {
  e(['jquery'], function (e) {
    return (function () {
      ...
      function c (t) { var o = m(); return v || n(o), t && e(':focus', t).length === 0 ? void h(t) : void (v.children().length && v.remove()) }

      function l (t) { for (var n = v.children(), o = n.length - 1; o >= 0; o--) u(e(n[o]), t) }

      function u (t, n, o) { var s = !(!o || !o.force) && o.force; return !(!t || !s && e(':focus', t).length !== 0) && (t[n.hideMethod]({ duration: n.hideDuration, easing: n.hideEasing, complete: function () { h(t) } }), !0) }
      ...
      function g (t) {
        function o (e) { return e == null && (e = ''), e.replace(/&/g, '&amp;').replace(/"/g, '&quot;').replace(/'/g, '&#39;').replace(/</g, '&lt;').replace(/>/g, '&gt;') }
        ...
        function b (t) {
          ...
          if (!e(':focus', I).length || t) return clearTimeout(F.intervalId), I[n]({ duration: o, easing: s, complete: function () { h(I), clearTimeout(k), E.onHidden && P.state !== 'hidden' && E.onHidden(), P.state = 'hidden', P.endTime = new Date(), f(P) } })
        }
        ...
        if (typeof t.optionsOverride !== 'undefined' && (E = e.extend(E, t.optionsOverride), y = t.optionsOverride.iconClass || y), !O(E, t)) {
          T++, v = n(E, !0)
          var k = null,
            I = e('<div/>'),
            M = e('<div/>'),
      ...
      function h (e) { v || (v = n()), e.is(':visible') || (e.remove(), e = null, v.children().length === 0 && (v.remove(), w = void 0)) }
      var v, C, w, T = 0,
...
}(typeof define === 'function' && define.amd ? define : function (e, t) { typeof module !== 'undefined' && module.exports ? module.exports = t(require('jquery')) : window.toastr = t(window.jQuery) }))
